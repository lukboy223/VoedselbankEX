                    ...
                    <div class="p-6 text-[#4F4F4F]">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="p-4 rounded-lg border-2 border-[#D0D0D0]">
                                <h4
                                    class="text-lg font-semibold mb-4 text-[#4F4F4F] bg-[#B5D2AA] rounded-lg text-center">
                                    Leverancier Informatie</h4>
                                <div class="space-y-3">
                                    <div>
                            ...
                            <div class=" p-4 rounded-lg border-2 border-[#D0D0D0]">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="ml-2">{{ $supplier->Housenumber }} {{$supplier->Addition}}</span>
                                    </div>
                                    <div>
